...
# for Premium 
IS_PREMIUM = is_enabled('IS_PREMIUM', False)  # Default to False
...
# Only disable premium if explicitly requested
if IS_PREMIUM and (len(UPI_ID) == 0 or len(UPI_NAME) == 0):
    logger.warning('IS_PREMIUM disabled due to empty UPI_ID or UPI_NAME')
    IS_PREMIUM = False
